    ...
    document.querySelector('#startbutton').addEventListener('click', function(event) {
            ...
            if (sessionStorage.getItem("actif") != null){
                ...
                modal.querySelector('#close_save').addEventListener('click', function(e) {
                    ...
                    event.preventDefault();
                    var modal = document.querySelector('#modal_filter');
                    var html = document.querySelector('html');
                    modal.classList.add('is-active');
                    html.classList.add('is-clipped');

                    modal.querySelector('#div_filter').addEventListener('click', function(e) {
                      e.preventDefault();
                      modal.classList.remove('is-active');
                      html.classList.remove('is-clipped');
                    });
                    modal.querySelector('#delete_filter').addEventListener('click', function(e) {
                      e.preventDefault();
                      modal.classList.remove('is-active');
                      html.classList.remove('is-clipped');
                    });
