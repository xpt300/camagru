...
<div class="columns is-vcentered">
    <div class="column is-three-fifths">
                <center>
                    <img class="img_move" id="filter1" style="position: absolute; z-index: 5; display: none; top: 38%; left: 12%" width="96px" height="96px" src="./other/StickPNG/5a39135643754d312f78e563.png">
                    <img class="img_move" id="filter2"style="position: absolute; z-index: 5; display: none; top: 38%; left: 12%" width="96px" height="96px" src="./other/StickPNG/5b6b204baa22c0115c0a56ee.png">
                    <img class="img_move" id="filter3" style="position: absolute; z-index: 5; display: none; top: 38%; left: 12%" width="96px" height="96px" src="./other/StickPNG/580b57fbd9996e24bc43be5c.png">
                    <img class="img_move" id="filter4" style="position: absolute; z-index: 5; display: none; top: 38%; left: 12%" width="96px" height="96px" src="./other/StickPNG/584be22724222481f5d0a3e1.png">
                    <img class="img_move" id="filter5" style="position: absolute; z-index: 5; display: none; top: 38%; left: 12%" width="96px" height="96px" src="other/StickPNG/5845e10e7733c3558233c0ea.png">
                    <img class="img_move" id="filter6" style="position: absolute; z-index: 5; display: none; top: 38%; left: 12%" width="96px" height="96px" src="other/StickPNG/5845e635fb0b0755fa99d7e9.png">
            ...
            while ($donnee = $reponse->fetch()){
                ...
                <div class="column">
                    <figure class="image is-5by4">
                        ...
                        <button class="delete" id="<?php echo $donnee['path_img']?>"></button>
                    </figure>
                </div>
                <?php
                if ($a == 2){
